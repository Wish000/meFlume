...
public class ReliableTaildirEventReader implements ReliableEventReader {
  ...
  private ReliableTaildirEventReader(Map<String, String> filePaths,
      ...
      boolean skipToEnd, boolean addByteOffset, boolean cachePatternMatching, boolean isRecursive,
    ...
    for (Entry<String, String> e : filePaths.entrySet()) {
      taildirCache.add(new TaildirMatcher(e.getKey(), e.getValue(), cachePatternMatching, isRecursive));
    }
  ...
  public static class Builder {
    ...
    public Builder recursive(boolean isRecursive) {
    ...
    public ReliableTaildirEventReader build() throws IOException {
      return new ReliableTaildirEventReader(filePaths, headerTable, positionFilePath, skipToEnd,
                                            addByteOffset, cachePatternMatching, isRecursive,
